...
[**\[Paper #1\]**](https://www.doi.org/10.5220/0013304400003890) [**\[Presentation slides\]**](https://kerrlya.github.io/files/Model_Characterization_with_Inductive_Orientation_Vectors_Presentation.pdf): Pang-Naylor, K., Chen, E., Montañez, G. (in press). Analyzing and Comparing Machine Learning Models via Inductive Orientation. In International Conference on Agents and Artificial Intelligence. Springer International Publishing.

[**\[Paper #2\]** (publish date: Dec. 5th, 2025)](): Pang-Naylor, K., Chen, E., Montañez, G. (in press). Analyzing and Comparing Machine Learning Models via Inductive Orientation. In International Conference on Agents and Artificial Intelligence. Springer International Publishing.
